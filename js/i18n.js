...
const I18N_DICT = {
  pt: {
    ...
    'auto.futuro': '{n} pedidos de {autor} serão rejeitados — toque para cancelar',
    'auto.cancelado': 'Cancelado: {n} pedidos de {autor} continuam na fila',
    'auto.feito': '{n} pedidos de {autor} rejeitados — toque para desligar isto',
    'auto.desligado': 'Recusa automática desligada para {autor}',
    'stats.autores.auto': 'Rejeitar sozinho os próximos deste autor',
    'stats.autores.autoDesc': 'O interruptor rejeita sozinho os próximos pedidos — você tem 20s para cancelar.',
  ...
  en: {
    ...
    'auto.futuro': '{n} requests from {autor} will be rejected — tap to cancel',
    'auto.cancelado': 'Cancelled: {n} requests from {autor} stay in the queue',
    'auto.feito': '{n} requests from {autor} rejected — tap to turn this off',
    'auto.desligado': 'Automatic rejection turned off for {autor}',
    'stats.autores.auto': 'Auto-reject this author’s next requests',
    'stats.autores.autoDesc': 'The switch rejects their next requests on its own — you get 20s to cancel.',
  ...
  es: {
    ...
    'auto.futuro': '{n} solicitudes de {autor} serán rechazadas — toca para cancelar',
    'auto.cancelado': 'Cancelado: {n} solicitudes de {autor} siguen en la cola',
    'auto.feito': '{n} solicitudes de {autor} rechazadas — toca para desactivar esto',
    'auto.desligado': 'Rechazo automático desactivado para {autor}',
    'stats.autores.auto': 'Rechazar solo las próximas de este autor',
    'stats.autores.autoDesc': 'El interruptor rechaza solo las próximas solicitudes — tienes 20s para cancelar.',
  ...
  fr: {
    ...
    'auto.futuro': '{n} demandes de {autor} vont être rejetées — touchez pour annuler',
    'auto.cancelado': 'Annulé : {n} demandes de {autor} restent dans la file',
    'auto.feito': '{n} demandes de {autor} rejetées — touchez pour désactiver',
    'auto.desligado': 'Rejet automatique désactivé pour {autor}',
    'stats.autores.auto': 'Rejeter seul les prochaines de cet auteur',
    'stats.autores.autoDesc': 'L’interrupteur rejette seul les prochaines demandes — vous avez 20s pour annuler.',
