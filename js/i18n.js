...
const I18N_DICT = {
  pt: {
    ...
    'modal.deletePhoto.title': 'Excluir esta foto?',
    'modal.deletePhoto.body': 'A foto sai do local no Waze, para todo mundo. Não é o mesmo que rejeitar um pedido, e não dá pra desfazer aqui.',
    'modal.deletePhoto.confirm': 'Excluir',
    'modal.deletePhoto.working': 'Excluindo…',
  ...
  en: {
    ...
    'modal.deletePhoto.title': 'Delete this photo?',
    'modal.deletePhoto.body': 'The photo comes off the place on Waze, for everyone. This is not the same as rejecting a request, and it cannot be undone here.',
    'modal.deletePhoto.confirm': 'Delete',
    'modal.deletePhoto.working': 'Deleting…',
  ...
  es: {
    ...
    'modal.deletePhoto.title': '¿Borrar esta foto?',
    'modal.deletePhoto.body': 'La foto sale del lugar en Waze, para todo el mundo. No es lo mismo que rechazar una solicitud, y aquí no se puede deshacer.',
    'modal.deletePhoto.confirm': 'Borrar',
    'modal.deletePhoto.working': 'Borrando…',
  ...
  fr: {
    ...
    'modal.deletePhoto.title': 'Supprimer cette photo ?',
    'modal.deletePhoto.body': 'La photo quitte le lieu sur Waze, pour tout le monde. Ce n’est pas la même chose que refuser une demande, et c’est irréversible ici.',
    'modal.deletePhoto.confirm': 'Supprimer',
    'modal.deletePhoto.working': 'Suppression…',
