...
const I18N_DICT = {
  pt: {
    ...
    // SCREAMING_SNAKE nunca chega na tela. Tradução completa é trabalho à parte.
    'card.cat.GAS_STATION': 'Posto de gasolina',
    'card.cat.OTHER': 'Outros',
    'card.cat.PLAZA': 'Praça',
    'card.cat.SHOPPING_AND_SERVICES': 'Comércio e serviços',
    'card.cat.SCHOOL': 'Escola',
    'card.cat.RESTAURANT': 'Restaurante',
    'card.cat.FACTORY_INDUSTRIAL': 'Fábrica / indústria',
    'card.cat.CHARGING_STATION': 'Ponto de recarga',
    'card.cat.DOCTOR_CLINIC': 'Clínica médica',
    'card.cat.SUPERMARKET_GROCERY': 'Supermercado',
    'card.cat.HOTEL': 'Hotel',
    'card.cat.SEA_LAKE_POOL': 'Mar / lago / piscina',
    'card.cat.PARKING_LOT': 'Estacionamento',
    'card.cat.FAST_FOOD': 'Fast-food',
    'card.cat.CEMETERY': 'Cemitério',
    'card.cat.PET_STORE_VETERINARIAN_SERVICES': 'Pet shop / veterinário',
    'card.cat.PHARMACY': 'Farmácia',
    'card.cat.BANK_FINANCIAL': 'Banco / financeira',
    'card.cat.HOSPITAL_MEDICAL_CARE': 'Hospital',
    'card.cat.CHURCH': 'Igreja',
  ...
  en: {
    ...
    'card.cat.OTHER': 'Other',
    'card.cat.PLAZA': 'Plaza',
    'card.cat.SHOPPING_AND_SERVICES': 'Shopping and services',
    'card.cat.SCHOOL': 'School',
    'card.cat.RESTAURANT': 'Restaurant',
    'card.cat.FACTORY_INDUSTRIAL': 'Factory / industrial',
    'card.cat.CHARGING_STATION': 'Charging station',
    'card.cat.DOCTOR_CLINIC': 'Doctor / clinic',
    'card.cat.SUPERMARKET_GROCERY': 'Supermarket / grocery',
    'card.cat.HOTEL': 'Hotel',
    'card.cat.SEA_LAKE_POOL': 'Sea / lake / pool',
    'card.cat.PARKING_LOT': 'Parking lot',
    'card.cat.FAST_FOOD': 'Fast food',
    'card.cat.CEMETERY': 'Cemetery',
    'card.cat.PET_STORE_VETERINARIAN_SERVICES': 'Pet store / veterinarian',
    'card.cat.PHARMACY': 'Pharmacy',
    'card.cat.BANK_FINANCIAL': 'Bank / financial',
    'card.cat.HOSPITAL_MEDICAL_CARE': 'Hospital / medical care',
    'card.cat.CHURCH': 'Church',
  ...
  es: {
    ...
    'card.cat.OTHER': 'Otros',
    'card.cat.PLAZA': 'Plaza',
    'card.cat.SHOPPING_AND_SERVICES': 'Comercio y servicios',
    'card.cat.SCHOOL': 'Escuela',
    'card.cat.RESTAURANT': 'Restaurante',
    'card.cat.FACTORY_INDUSTRIAL': 'Fábrica / industria',
    'card.cat.CHARGING_STATION': 'Punto de carga',
    'card.cat.DOCTOR_CLINIC': 'Clínica médica',
    'card.cat.SUPERMARKET_GROCERY': 'Supermercado',
    'card.cat.HOTEL': 'Hotel',
    'card.cat.SEA_LAKE_POOL': 'Mar / lago / piscina',
    'card.cat.PARKING_LOT': 'Estacionamiento',
    'card.cat.FAST_FOOD': 'Comida rápida',
    'card.cat.CEMETERY': 'Cementerio',
    'card.cat.PET_STORE_VETERINARIAN_SERVICES': 'Tienda de mascotas / veterinario',
    'card.cat.PHARMACY': 'Farmacia',
    'card.cat.BANK_FINANCIAL': 'Banco / financiera',
    'card.cat.HOSPITAL_MEDICAL_CARE': 'Hospital',
    'card.cat.CHURCH': 'Iglesia',
  ...
  fr: {
    ...
    'card.cat.OTHER': 'Autre',
    'card.cat.PLAZA': 'Place',
    'card.cat.SHOPPING_AND_SERVICES': 'Commerces et services',
    'card.cat.SCHOOL': 'École',
    'card.cat.RESTAURANT': 'Restaurant',
    'card.cat.FACTORY_INDUSTRIAL': 'Usine / industrie',
    'card.cat.CHARGING_STATION': 'Borne de recharge',
    'card.cat.DOCTOR_CLINIC': 'Cabinet médical',
    'card.cat.SUPERMARKET_GROCERY': 'Supermarché',
    'card.cat.HOTEL': 'Hôtel',
    'card.cat.SEA_LAKE_POOL': 'Mer / lac / piscine',
    'card.cat.PARKING_LOT': 'Parking',
    'card.cat.FAST_FOOD': 'Restauration rapide',
    'card.cat.CEMETERY': 'Cimetière',
    'card.cat.PET_STORE_VETERINARIAN_SERVICES': 'Animalerie / vétérinaire',
    'card.cat.PHARMACY': 'Pharmacie',
    'card.cat.BANK_FINANCIAL': 'Banque / finance',
    'card.cat.HOSPITAL_MEDICAL_CARE': 'Hôpital',
    'card.cat.CHURCH': 'Église',
