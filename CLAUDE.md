...
**E o teto do ANEL sai dos 30 DIAS, não do write** (v2026.08.28-01) — a parte que engana. O mapa expira por IDADE e o anel por CAPACIDADE: se ele não segurar 30 dias de rejeições, a app para de promover quem foi rejeitado no dia 1 e no dia 25, porque o id do dia 1 saiu por lotação. A promessa do próprio card quebra **em silêncio**. Com 2.000 a fila real do owner (856 rejeições numa semana, ~120/dia) dava **19 dias** contra os 30 prometidos; hoje são 4.000 (~38 dias). **A tabela de write acima NÃO vale pro anel**: ela mede o mapa `nome → [contagem, datas]`, muito mais pesado por entrada. Medido no ciclo completo de uma rejeição, CPU 6× lenta: anel de 2.000 → 4,04 ms · 4.000 → 4,32 ms · 8.000 → 4,72 ms (um quadro são 8,3 ms), e 39,6 → 63,0 KB. Quem rejeitar muito mais que ~130/dia volta a não cobrir os 30 dias; o conserto sem palpite é guardar o DIA no anel e podar por idade, ao custo de mudar o formato gravado.
