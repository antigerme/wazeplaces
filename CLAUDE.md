...
**Estrutura nova que cresce por item precisa de teto POR CONSTRUÇÃO, e a conta é do write.** A reincidência por autor tem duas listas porque a fila real diz que **87% dos autores mandam um pedido só** (81–91% em 12 países) e a área do owner recebe **~360 autores distintos por dia**: um mapa único estouraria 2.000 registros em menos de uma semana. Quem foi rejeitado UMA vez mora num anel de ids (sem nome, sem data) e só é promovido na SEGUNDA. Medido: 41 KB e 0,87 ms.
