...
- **UM indicador para os dois estados**, e o giro só aparece quando está MESMO saindo (`inFlightActions > 0`). "Esperando" com spinner seria a app fingindo trabalho justamente no estado em que não há rede pra trabalhar. **Sem toast por ação**: 150 pedidos numa sombra dariam 150 interrupções; quem presta contas é o "N esperando envio", que some sozinho.
