...
**A primeira passada é SILENCIOSA** (`g.base`): quem já tem 3.000 pedidos nas costas destrava oito de uma vez, e oito banners seguidos não é festa. Mesmo raciocínio do `initUndoGateSeen` — e, como lá, **não é migração**: todo aparelho novo também passa por aqui. **Um aviso por vez, e a patente ganha**; a conquista engolida aparece ganha no Histórico.
