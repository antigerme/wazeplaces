...
│   ├── esperar-saida.mjs    # FONTE ÚNICA de esperar o esvaziamento da FILA DE SAÍDA num
│   │                        #   smoke. Poll pelo lado do NODE, por sinal POSITIVO, e DIZ por
│   │                        #   que terminou — `page.waitForFunction` tem quatro armadilhas
│   │                        #   aqui, e as quatro já morderam (ver a seção da fila de saída).
